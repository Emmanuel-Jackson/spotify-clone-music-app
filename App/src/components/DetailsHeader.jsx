...
const DetailsHeader = ({ artistId, artistData, songData }) => {
  ...
  <div className="relative w-full flex flex-col">
    <div className="w-full from-transparent to-black sm:h-48 h-28" />
    <div className="absolute inset-0 flex items-center">
      ...
      <div className="ml-5">
        <p className="font-bold sm:text-3-xl text-xl text-white">{artistId ? artist?.name : songData?.title}</p>
        {!artistId && (
